...
f_spec = Fermion(out2, in2).addArrow().addLabel(r"\APquark",)
f1 = Fermion(in1, loop_in).addArrow().addLabel(r"\Pbottom",size= pyx.text.size.Huge )
f2 = Fermion(loop_in, out1a).addArrow().addLabel(r"\Pmuon",size= pyx.text.size.Huge )
...
f3 = Fermion(vtx, outl).addArrow().addLabel(r"\Pstrange",size= pyx.text.size.Huge )
f4 = Fermion(outal,vtx).addArrow().addLabel(r"\APmuon",displace=0.3,size= pyx.text.size.Huge )
